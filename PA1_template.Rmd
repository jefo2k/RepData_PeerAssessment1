...
The mean of the total number of steps is: `r format(steps_mean, nsmall=2)`

The median of the total number of steps is: `r steps_median`
...
The 5-minute interval, on average across all the days in the dataset, that contains the maximum number of steps is: `r int_max_num_steps`
...
Total number of rows with NAs is: `r total_na`
...
The mean of the total number of steps is: `r format(steps_mean_no_nas, nsmall=2)`

The median of the total number of steps is: `r format(steps_median_no_nas, nsmall=2)`
